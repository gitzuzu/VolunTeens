...
public class TestimonialController {
    ...
    public ModelAndView showTestimonials() {
    ...
    public ModelAndView showTestimonialForm() {
    ...
    public ModelAndView submitTestimonial(@Valid @ModelAttribute Testimonial testimonial, BindingResult result) {
        if (result.hasErrors()) {
            ModelAndView modelAndView = new ModelAndView("Testimonialform");
            return modelAndView;
        }
